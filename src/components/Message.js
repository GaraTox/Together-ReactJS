...
function Message() {
    ...
    <div className="contenuPrincipal">
        <div className="blocAmis">
            <div className="titreAmis"><p className="text-center text-light bg bg-dark"><img src={friend} className="me-1 mb-1 bg bg-light rounded p-1 m-1" alt="message"/><strong>Amis</strong></p></div>
